...
class CurrentUserProductsAdapter (val context: Context, private var productList: MutableList<ProductsModel>) : RecyclerView.Adapter<CurrentUserProductsAdapter.ViewHolder>() {
